...
return {
  ...
  frun = function(self,wfilename,rundebug)
    local corona = pathcache -- check if the path is configured
    if not corona then
      ...
      if not corona then
        print("Can't find corona executable in any of the folders in PATH: MISSING");
        return
      end
      pathcache = corona
    end
